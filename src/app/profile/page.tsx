  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 flex flex-col font-sans">
      <main className="max-w-4xl w-full mx-auto px-4 sm:px-8 py-8 space-y-8 flex-1 pb-24 lg:pb-0">
        ...
        <div className="bg-gradient-to-r from-sky-700 via-blue-800 to-indigo-900 rounded-3xl p-6 md:p-8 text-white shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 relative overflow-hidden">
          <div className="absolute -right-12 -bottom-12 w-56 h-56 bg-sky-400/10 rounded-full blur-2xl pointer-events-none" />
          <div className="absolute left-1/3 -top-12 w-40 h-40 bg-indigo-400/15 rounded-full blur-xl pointer-events-none" />

          <div className="relative z-10 flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-white/15 backdrop-blur-md flex items-center justify-center text-white shrink-0 border border-white/20 shadow-md">
              <Building2 className="w-7 h-7 text-sky-200" />
            </div>
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <span className="px-3 py-0.5 rounded-full text-[10px] font-black uppercase bg-white/20 text-sky-100 tracking-wider border border-white/20">
                  Govt. of India • Academic Depository
                </span>
                {isDigiLockerVerified ? (
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-emerald-400/30 text-emerald-200 border border-emerald-300/40 flex items-center gap-1">
                    <CheckCircle2 className="w-3 h-3" /> Verified
                  </span>
                ) : (
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-amber-400/30 text-amber-200 border border-amber-300/40 flex items-center gap-1">
                    <ShieldCheck className="w-3 h-3" /> Pending Verification
                  </span>
                )}
              </div>
              <h2 className="text-xl font-black tracking-tight mt-1">DigiLocker Identity Verification</h2>
          ...
          <button
            ...
            className={`w-full sm:w-auto px-6 py-3.5 font-extrabold text-xs rounded-2xl shadow-lg active:scale-95 transition-all flex items-center justify-center gap-2 shrink-0 cursor-pointer ${
              isDigiLockerVerified
                ? 'bg-emerald-500 hover:bg-emerald-600 text-white shadow-emerald-950/20'
                : 'bg-white hover:bg-sky-50 text-blue-950 shadow-blue-950/20'
            }`}
          >
